# This file was generated by the {rix} R package v0.18.1 on 2026-04-30
# with following call:
# >rix(r_ver = "4.5.3",
#  > r_pkgs = r_pkgs,
...
#
# MANUAL PATCH:
# 1. Override udunits with -std=gnu89 (Apple Silicon Clang fix)
# 2. shellHook rebuilds R_LIBS_SITE from derivation closure (nested shell fix)
let
